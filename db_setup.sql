...
INSERT ALL INTO Kocury (imie, plec, pseudo, funkcja, szef, w_stadku_od, przydzial_myszy, myszy_extra, nr_bandy)
...
INSERT ALL INTO Wrogowie_Kocurow (pseudo, imie_wroga, data_incydentu, opis_incydentu)
...
ALTER TABLE Kocury
  ADD CONSTRAINT fk_kocury_kocury FOREIGN KEY (szef) REFERENCES Kocury (pseudo);